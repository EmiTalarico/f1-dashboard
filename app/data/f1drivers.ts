...
// Números de salida oficiales temporada 2026.
// Norris lleva el #1 por ser campeón vigente; Verstappen vuelve a su #3 habitual.
export const F1_DRIVERS: Record<string, F1Driver> = {
  '1':  { number: '1',  acronym: 'NOR', fullName: 'Lando Norris',         team: 'McLaren',       teamColor: 'FF8000', flag: '🇬🇧' },
  '3':  { number: '3',  acronym: 'VER', fullName: 'Max Verstappen',       team: 'Red Bull',      teamColor: '3671C6', flag: '🇳🇱' },
