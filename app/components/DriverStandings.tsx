...
const FALLBACK_DRIVERS = [
  { position: '1',  givenName: 'Kimi',     familyName: 'Antonelli',  nationality: 'Italian',       team: 'Mercedes',     points: '219', wins: '6' },
  { position: '3',  givenName: 'Lewis',    familyName: 'Hamilton',   nationality: 'British',       team: 'Ferrari',      points: '169', wins: '1' },
  { position: '2',  givenName: 'George',   familyName: 'Russell',    nationality: 'British',       team: 'Mercedes',     points: '160', wins: '2' },
  { position: '6',  givenName: 'Charles',  familyName: 'Leclerc',    nationality: 'Monegasque',    team: 'Ferrari',      points: '138',  wins: '1' },
  { position: '5',  givenName: 'Lando',    familyName: 'Norris',     nationality: 'British',       team: 'McLaren',      points: '128',  wins: '1' },
  { position: '7',  givenName: 'Max',      familyName: 'Verstappen', nationality: 'Dutch',         team: 'Red Bull Racing', points: '109', wins: '0' },
  { position: '4',  givenName: 'Oscar',    familyName: 'Piastri',    nationality: 'Australian',    team: 'McLaren',      points: '92',  wins: '0' },
  { position: '8',  givenName: 'Isack',    familyName: 'Hadjar',     nationality: 'French',        team: 'Red Bull Racing', points: '68', wins: '0' },
  { position: '10', givenName: 'Liam',     familyName: 'Lawson',     nationality: 'New Zealander', team: 'Racing Bulls', points: '43',  wins: '0' },
  { position: '9',  givenName: 'Pierre',   familyName: 'Gasly',      nationality: 'French',        team: 'Alpine',       points: '42',  wins: '0' },
  { position: '13', givenName: 'Arvid',    familyName: 'Lindblad',   nationality: 'Swedish',       team: 'Racing Bulls', points: '23',  wins: '0' },
  { position: '12', givenName: 'Franco',   familyName: 'Colapinto',  nationality: 'Argentine',     team: 'Alpine',       points: '19',  wins: '0' },
  ...
  { position: '19', givenName: 'Nico',     familyName: 'Hulkenberg', nationality: 'German',        team: 'Audi',         points: '2',   wins: '0' },
